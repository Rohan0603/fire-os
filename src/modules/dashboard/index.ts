...
function renderFIProgressCard(progressPercent: number): string {
  ...
  return `
    <div class="kpi-card ${cardClass}">
      ...
      <div class="kpi-card-subtitle">${progressPercent >= 100 ? 'Financial Freedom Achieved!' : 'Towards 25x expenses'}</div>
    </div>
  `;
}
  ...
  return `
    <div class="portfolio-summary">
      <div class="portfolio-summary-grid">
        ...
        <div class="portfolio-summary-item">
          <div class="portfolio-summary-label">FI Target (25x)</div>
